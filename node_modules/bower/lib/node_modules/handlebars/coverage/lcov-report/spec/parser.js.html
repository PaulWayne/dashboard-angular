...
<span class="cstat-no" title="statement not covered" >    equals(ast_for('{{foo}}'), "{{ foo [] }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for('{{foo?}}'), "{{ foo? [] }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for('{{foo_}}'), "{{ foo_ [] }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for('{{foo-}}'), "{{ foo- [] }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for('{{foo:}}'), "{{ foo: [] }}\n");</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo/bar}}"), "{{ foo/bar [] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with this/foo', <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{this/foo}}"), "{{ foo [] }}\n");</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar}}"), "{{ foo [ID:bar] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with string parameters', <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar \"baz\" }}"), '{{ foo [ID:bar, "baz"] }}\n');</span>
  });
&nbsp;
  it('parses mustaches with NUMBER parameters', <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo 1}}"), "{{ foo [NUMBER{1}] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with BOOLEAN parameters', <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo true}}"), "{{ foo [BOOLEAN{true}] }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo false}}"), "{{ foo [BOOLEAN{false}] }}\n");</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar=baz}}"), "{{ foo [] HASH{bar=ID:baz} }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar=1}}"), "{{ foo [] HASH{bar=NUMBER{1}} }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar=true}}"), "{{ foo [] HASH{bar=BOOLEAN{true}} }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar=false}}"), "{{ foo [] HASH{bar=BOOLEAN{false}} }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar=@baz}}"), "{{ foo [] HASH{bar=@baz} }}\n");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar=baz bat=bam}}"), "{{ foo [] HASH{bar=ID:baz, bat=ID:bam} }}\n");</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bar=baz bat=\"bam\"}}"), '{{ foo [] HASH{bar=ID:baz, bat="bam"} }}\n');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo bat='bam'}}"), '{{ foo [] HASH{bat="bam"} }}\n');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo omg bar=baz bat=\"bam\"}}"), '{{ foo [ID:omg] HASH{bar=ID:baz, bat="bam"} }}\n');</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo omg bar=baz bat=\"bam\" baz=1}}"), '{{ foo [ID:omg] HASH{bar=ID:baz, bat="bam", baz=NUMBER{1}} }}\n');</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo omg bar=baz bat=\"bam\" baz=true}}"), '{{ foo [ID:omg] HASH{bar=ID:baz, bat="bam", baz=BOOLEAN{true}} }}\n');</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{foo omg bar=baz bat=\"bam\" baz=false}}"), '{{ foo [ID:omg] HASH{bar=ID:baz, bat="bam", baz=BOOLEAN{false}} }}\n');</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{&gt; foo bar=bat}}"), "{{&gt; foo HASH{bar=ID:bat} }}\n");</span>
  });
&nbsp;
  it('parses a partial with context and hash', <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{&gt; foo bar bat=baz}}"), "{{&gt; foo bar HASH{bat=ID:baz} }}\n");</span>
  });
&nbsp;
  it('parses a partial with a complex name', <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    equals(ast_for("{{&gt; shared/partial?.bar}}"), "{{&gt; shared/partial?.bar }}\n");</span>
  });
&nbsp;
