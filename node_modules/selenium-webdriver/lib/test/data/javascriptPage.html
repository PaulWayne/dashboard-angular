...
<div id="formageddon">
    <form action="#">
        Key Up: <input type="text" id="keyUp" onkeyup="updateContent(this)"/><br/>
        Key Down: <input type="text" id="keyDown" onkeydown="updateContent(this)"/><br/>
        Key Press: <input type="text" id="keyPress" onkeypress="updateContent(this)"/><br/>
        Change: <input type="text" id="change" onkeypress="displayMessage('change')"/><br/>
        <textarea id="keyDownArea" onkeydown="updateContent(this)" rows="2" cols="15"></textarea>
        <textarea id="keyPressArea" onkeypress="updateContent(this)" rows="2" cols="15"></textarea>
        <textarea id="keyUpArea" onkeyup="updateContent(this)" rows="2" cols="15"></textarea>
        <select id="selector" onchange="updateContent(this)">
            <option value="foo">Foo</option>
            <option value="bar">Bar</option>
        </select>
        <select id="selector2" onclick="updateContent(this)">
            <option value="foo">Foo</option>
            <option value="bar">Bar</option>
        </select>
        <input type="checkbox" id="checkbox" value="checkbox thing" onchange="updateContent(this)"/>
...
<div>
    <p><a href="#" onclick="document.title='Changed'">Change the page title!</a></p>

    <p><a onclick="document.title='Changed'" id="nohref">No href</a></p>

    <p><a id="updatediv" href="#" onclick="document.getElementById('dynamo').innerHTML = 'Fish and chips!';">Update a
        div</a></p>
</div>

<div id="dynamo">What's for dinner?</div>

<div id="mousedown" onmousedown="displayMessage('mouse down');">
    <p>Click for the mouse down event</p>
    <span><p id="child">Here's some text</p></span>
</div>

<div id="mouseup" onmouseup="displayMessage('mouse up');">
    <p>Click for the mouse up event</p>
</div>

<div id="mouseclick" onclick="displayMessage('mouse click');">
...
<div>
  <form action="resultPage.html" id="on-form">
    ...
    <button type="button" id="jsSubmitButton" onclick="document.getElementById('on-form').submit();">Submitomatic</button>
